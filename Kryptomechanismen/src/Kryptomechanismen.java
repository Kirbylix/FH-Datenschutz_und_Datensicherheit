...
public class Kryptomechanismen {
    ...
    private static void symmetrischeVerschluesselung(String algorithm) {
        if (algorithm == "AES" || algorithm == "DES") {
            ...
            System.out.println("Der Text wurde mit: " + algorithm + " Verschlüsselt");
            File.writeFile(crypt, PATH, algorithm + "_crypt.txt");
        } else {
            System.out.println(algorithm + " ist kein Unterstützer Algorithmus");
        }
    }
    ...
    private static void symmetrischeEntschluesselnung(String algorithm) {
        if (algorithm == "AES" || algorithm == "DES") {
            ...
            System.out.println("Der Text wurde mit: " + algorithm + " Entschlüsselt");
    ...
    private static void asymmetrischeVerschluesselung() {
        ...
        System.out.println("Der Text wurde mit: RSA Verschlüsselt");
    ...
    private static void asymmetrischeEntschluesselnung() {
        ...
        System.out.println("Der Text wurde mit: RSA Entschlüsselt");
    ...
    private static void hashing(String algorithm) {
        if (algorithm == "MD5" || algorithm == "SHA-1") {
            ...
            System.out.println("Der Text wurde mit: " + algorithm + " gehasht");
            File.writeFile(crypt, PATH, algorithm + "_crypt.txt");
        } else {
            System.out.println(algorithm + " ist kein Unterstützer Algorithmus");
        }
    ...
    private static void digitalSignieren(String hashAlgorithm) {
        ...
        System.out.println("Digitale Signatur: Der Text wurde mit: " + hashAlgorithm + " gehasht");
        ...
        System.out.println("Digitale Signatur: Fingerprint wurde erstellt");
    ...
    private static void verifizieren(String hashAlgorithm) {
        ...
        if (same) {
            ...
            System.out.println("die Signatur stimmt --->> NICHT <<--- überein !!!!");
        }
    }
}