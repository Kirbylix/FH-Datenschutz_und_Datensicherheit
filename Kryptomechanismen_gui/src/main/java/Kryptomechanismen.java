...
/*
    ...
    public static void writeKeys(){
        File.writeFile(KEY_AES.toString(), PATH, "usedKeys.txt");
        File.writeFile(KEY_DES.toString(), PATH, "usedKeys.txt");
        //util.File.writeFile(KEY_AES.toString(), PATH, "usedKeys.txt");
        //util.File.writeFile(KEY_AES.toString(), PATH, "usedKeys.txt");
    }
}